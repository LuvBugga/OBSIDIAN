###### **Linux History**
 ...
 - The GNU project produced many essential components like, its own Kernel (called Hurd), GNU General Public License (GPL), it was not completed in time.
###### **Kernel**
- It is the core component of an Operating System/
- It acts as a bridge between the Hardware and the Software.
- It manages system resources, such as CPU, Memory, and Peripheral devices. (Basically it controls everything happening on your computer/system/laptop).
- While there were other UNIX-like systems such as BSD and MINIX, none of them had freely available and unified kernel.
